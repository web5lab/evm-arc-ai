  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 sm:w-14 sm:h-14 w-12 h-12 bg-gradient-to-r from-orange-500 to-orange-600 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center group z-50 bg-amber-500  hover:bg-amber-400  cursor-pointer hover:scale-110 animate-bounce"
      >
        ...
        <div className="fixed bottom-24 right-6 w-96 h-[600px] bg-white rounded-2xl shadow-2xl flex flex-col z-50">
          ...
          <div className="flex items-center justify-between p-4 border-b sticky top-0  bg-white z-10">
            <div className="flex items-center gap-2">
              ...
              <img src={logo} alt="" className='w-8 h-8 text-orange-500' />
              <span className="font-semibold">ArcAi Assistant</span>
            </div>
            <button
