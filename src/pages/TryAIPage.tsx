      ...
      <div className="md:w-[280px] bg-gray-50 border-r border-gray-200 flex flex-col h-auto md:h-[calc(100vh-4rem)] order-2 md:order-1">
        ...
        <div className="flex-1 overflow-y-auto px-4">
          {chats.map((chat) => (
            <div
              key={chat.id}
              className={`group relative rounded-lg cursor-pointer mb-2 ${activeChat === chat.id
          ...
          <div className="flex-1 overflow-y-auto">
            <div className="max-w-3xl mx-auto py-4 md:py-8 px-2 md:px-4">
              {activeMessages.map((message, index) => (
                ...
                >
                  <div className={`flex max-w-3xl mx-auto ${message.type === 'bot' ? 'bg-gray-50/80' : ''
                    }`}>
            ...
            <div className="max-w-3xl mx-auto p-2 md:p-4">
              ...
              <div className=" flex justify-center items-center">
                ...
                <button
                  ...
                  className=" p-1.5 text-gray-400 hover:text-orange-500 disabled:hover:text-gray-400 disabled:opacity-50 transition-colors  z-20"
                >
                  {isLoading ? (
